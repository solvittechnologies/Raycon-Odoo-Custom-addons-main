odoo.define('web_studio.html_frame', function (require) {
'use strict';
...
var FieldTextHtml = AbstractField.extend({
    ...
    get_url: function (_attr) {
        ...
        var k;
        var datarecord = this.record_data;
        var attr = {
            'model': this.model,
            'field': this.name,
    ...
    add_button: function () {
        ...
        $(QWeb.render('NewFieldTextHtmlTranslate', {'widget': this}))
            .appendTo($to)
...
field_registry.add('html_frame', FieldTextHtml);
